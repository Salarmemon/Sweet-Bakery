    ...
    return (
        <section id="menu" className="menu-section py-20 bg-gray-100">
            <div className="container mx-auto px-4">
                <h2 className="text-[clamp(0.8rem,3vw,4rem)] font-bold text-center mb-12 font-heading">Find Your Favorite Item</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    {dishes.map((dish) => (
                        <div key={dish.id} className="menu-item bg-white relative rounded-lg shadow-md overflow-hidden">
                            ...
                            <img src={dish.image} alt={`Menu Item ${dish.id}`} className="w-full h-full object-cover z-0" />
                            </motion.div>
